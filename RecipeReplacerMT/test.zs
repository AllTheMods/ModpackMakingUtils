...
recipes.addShaped(<railcraft:entity_locomotive_electric>.withTag({primaryColor: "yellow", secondaryColor: "black"}), [[<minecraft:redstone_lamp:*>, <ore:plateIron>, null], [<ore:plateIron>, <railcraft:charge_feeder>, <ore:plateIron>], [<railcraft:gear:2>, <minecraft:minecart>, <railcraft:gear:2>]]);
